...
class PersonServiceTest {
    ...
    void testFindById() {
        ...
        assertEquals("First Name Test1", result.getFirtName());
    ...
    void testFindAll() {
        ...
        assertEquals("First Name Test1", personOne.getFirtName());
        ...
        assertEquals("First Name Test4", personFour.getFirtName());
        ...
        assertEquals("First Name Test7", personSeven.getFirtName());
